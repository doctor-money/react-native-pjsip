...
- (instancetype) init {
    ...
    // Init pjsua
    {
        ...
        cfg.cb.on_pager_status2 = &onMessageAccepted;
...
//        cfg.cfg.cb.on_call_media_event = &on_call_media_event;
        ...
        // mediaConfig.ec_options = 64; //PJMEDIA_ECHO_USE_SW_ECHO
        // mediaConfig.no_vad = true;
        mediaConfig.ec_options = PJMEDIA_ECHO_USE_NOISE_SUPPRESSOR|PJMEDIA_ECHO_AGGRESSIVENESS_AGGRESSIVE;
        // mediaConfig.ec_tail_len = 250;
...
static void onMessageAccepted(pjsua_call_id call_id,
                 const pj_str_t *to,
                 const pj_str_t *body,
                 void *user_data,
