...
public class PjActions {
    ...
    public static final String ACTION_SEND_MESSEGE = "send_message";
    ...
    public static Intent sendInstantMessage(int callbackId, int accountId, String destination, String message, Context context) {
        Intent intent = new Intent(context, PjSipService.class);
        intent.setAction(PjActions.ACTION_SEND_MESSEGE);
        intent.putExtra("callback_id", callbackId);
        intent.putExtra("account_id", accountId);
